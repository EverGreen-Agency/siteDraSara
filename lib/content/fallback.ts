...
export const fallbackProfessionals: Professional[] = [
  {
    ...
    image: "/images/dr-sara-perfil.webp",
...
export const fallbackPages: Record<string, InstitutionalPage> = {
  ...
  "estetica-orofacial": {
    contentType: "page", slug: "estetica-orofacial", eyebrow: "Estética Orofacial", title: "Estética Orofacial com planejamento individual em Florianópolis", description: "Naturalidade e análise facial antes da escolha do procedimento.", image: "/images/dr-sara-estetica.webp", imageAlt: "Retrato editorial da Dra. Sara Michelon", seo: {title: "Estética Orofacial em Florianópolis | Dra. Sara Michelon", description: "Estética orofacial em Florianópolis com análise de proporções, movimento, pele e contornos antes da indicação.", canonical: "/estetica-orofacial", index: true},
  ...
  "dra-sara-michelon": {
    contentType: "page", slug: "dra-sara-michelon", eyebrow: "Dra. Sara Michelon", title: "Dra. Sara Michelon", description: "Odontologia e estética conduzidas com avaliação individual, planejamento e acompanhamento.", image: "/images/dr-sara-autoridade.webp", imageAlt: "Retrato profissional da Dra. Sara Michelon", seo: {title: "Dra. Sara Michelon | Odontologia e Estética em Florianópolis", description: "Conheça a abordagem clínica da Dra. Sara Michelon em odontologia e estética nos Ingleses, Florianópolis.", canonical: "/dra-sara-michelon", index: true},
  ...
  contato: {contentType: "page", slug: "contato", eyebrow: "Contato e localização", title: "Clínica odontológica nos Ingleses, Florianópolis", description: "A clínica atende nos Ingleses, no Norte da Ilha. Os canais oficiais de contato e a rota serão exibidos nesta página quando configurados no site.", image: "/images/clinica-entrada.webp", imageAlt: "Entrada da clínica da Dra. Sara Michelon nos Ingleses", seo: {title: "Contato e Localização | Dra. Sara Michelon — Ingleses", description: "Clínica odontológica da Dra. Sara Michelon nos Ingleses, Norte da Ilha de Florianópolis.", canonical: "/contato", index: true}},
