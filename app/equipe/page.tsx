...
export default async function EquipePage() {
  ...
  return <>
    ...
    <Section><Container><ImageFrame src={page.image ?? "/images/equipe.webp"} alt={page.imageAlt ?? "Equipe da clínica da Dra. Sara Michelon"} fill priority sizes="100vw" className="min-h-[620px]" /></Container></Section>
